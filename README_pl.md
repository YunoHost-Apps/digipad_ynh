...
[![Poziom integracji](https://apps.yunohost.org/badge/integration/digipad)](https://ci-apps.yunohost.org/ci/apps/digipad/)
![Status działania](https://apps.yunohost.org/badge/state/digipad)
![Status utrzymania](https://apps.yunohost.org/badge/maintained/digipad)

[![Zainstaluj Digipad z YunoHost](https://install-app.yunohost.org/install-with-yunohost.svg)](https://install-app.yunohost.org/?app=digipad)
...
![Zrzut ekranu z Digipad](./doc/screenshots/screenshot.png)
